...
class DPCode(StrEnum):
    ...
    # HomeGate gate operator specific codes
    GATE_STATUS = "状态返回"  # Status return
    GATE_CLOSE_TRAVEL = "关行程"  # Close travel
    GATE_OPEN_TRAVEL = "开行程"  # Open travel
    GATE_QUICK_OPEN = "快捷开门"  # Quick open door
    GATE_SIGNAL_STRENGTH = "信号强度显示"  # Signal strength display
    GATE_OPEN = "open"  # Open command
    GATE_CLOSE = "close"  # Close command
    GATE_STOP = "stop"  # Stop command
    GATE_LOCK = "lock"  # Lock command
